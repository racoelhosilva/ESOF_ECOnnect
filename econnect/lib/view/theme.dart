...
class MaterialTheme {
  ...
  static MaterialScheme lightScheme() {
    return const MaterialScheme(
      ...
      secondaryFixed: Color(0xff9ef2e2),
      onSecondaryFixed: Color(0xff00201c),
      secondaryFixedDim: Color(0xff83d5c7),
  ...
  static MaterialScheme lightMediumContrastScheme() {
    return const MaterialScheme(
      ...
      secondary: Color(0xff004c43),
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xff298275),
      onSecondaryContainer: Color(0xffffffff),
      tertiary: Color(0xff004a52),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff24808a),
      ...
      secondaryFixed: Color(0xff298275),
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff00685c),
      onSecondaryFixedVariant: Color(0xffffffff),
      tertiaryFixed: Color(0xff24808a),
      onTertiaryFixed: Color(0xffffffff),
      tertiaryFixedDim: Color(0xff00666f),
  ...
  static MaterialScheme lightHighContrastScheme() {
    return const MaterialScheme(
      ...
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xff004c43),
      onSecondaryContainer: Color(0xffffffff),
      ...
      onPrimaryFixedVariant: Color(0xffffffff),
      secondaryFixed: Color(0xff004c43),
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff00332d),
      onSecondaryFixedVariant: Color(0xffffffff),
  ...
  static MaterialScheme darkHighContrastScheme() {
    return const MaterialScheme(
      ...
      onPrimaryContainer: Color(0xff000000),
      secondary: Color(0xffebfff9),
      onSecondary: Color(0xff000000),
      secondaryContainer: Color(0xff87dacb),
      onSecondaryContainer: Color(0xff000000),
      tertiary: Color(0xfff0fdff),
      onTertiary: Color(0xff000000),
      tertiaryContainer: Color(0xff85d8e3),
      onTertiaryContainer: Color(0xff000000),
      ...
      secondaryFixed: Color(0xffa3f6e7),
      onSecondaryFixed: Color(0xff000000),
      secondaryFixedDim: Color(0xff87dacb),
      onSecondaryFixedVariant: Color(0xff001a16),
      tertiaryFixed: Color(0xffa3f4ff),
      onTertiaryFixed: Color(0xff000000),
      tertiaryFixedDim: Color(0xff85d8e3),
